  ...
  render() {
    return (
      <>
        ...
        <h2 className="text-start text-danger my-3">Tasks</h2>
        <hr />
          <table class="table">
            <thead>
              <tr>
          ...
          <div className="d-flex justify-content-evenly">
            <button className="btn btn-outline-info w-25 p-1 my-1 btn-sm" onClick={this.PrevTasks}>
              Previous
            </button>
            <button
              className="btn btn-outline-info w-25 p-1 my-1 btn-sm"
